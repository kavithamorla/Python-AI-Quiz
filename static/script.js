...
function showSection(section) {
  [setupSection, loadingSection, quizSection, resultsSection].forEach((node) => node.classList.add("hidden"));
...
function renderQuiz(quiz) {
  quizTitleEl.textContent = quiz.quiz_title || "Premium Python Quiz";
